...
const en: Dictionary = {
  ...
  "menu.about": "About",
  "totalProfit": "Total profit: {value}",
  "filters.label": "Filters",
  "filters.names": "Names",
  "filters.selected": "{count} selected",
  "filters.all": "All",
  "filters.filterByNames": "Filter by names",
  "filters.noNames": "No names available",
...
const zh_cn: Dictionary = {
  ...
  "menu.settings": "设置",
  "menu.about": "关于",
  "totalProfit": "总盈亏：{value}",
  "filters.label": "筛选",
  "filters.names": "名称",
  "filters.selected": "已选 {count} 项",
  "filters.all": "全部",
  "filters.filterByNames": "按名称筛选",
  "filters.noNames": "暂无可用名称",
  "filters.status": "状态",
